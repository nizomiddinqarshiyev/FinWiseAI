              ...
              <div className="relative mb-6">
                {member.photo ? (
                  <img
                    ...
                    alt={member.name}
                    loading="lazy"
                    className="w-24 h-24 mx-auto rounded-2xl object-cover shadow-lg border border-slate-700 group-hover:scale-110 transition-transform duration-300"
                  />
                ) : (
